...
const RegisterSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showSuccess('Account created successfully! Welcome to DocLink.');
      navigate('/');
    } catch (err) {
      showError('Failed to create an account. Please try again.');
      console.error(err);
    } finally {
      setLoading(false);
    }
        ...
        <Card className="bg-background-secondary/50 backdrop-blur-xl border-border/50 rounded-3xl overflow-hidden shadow-2xl">
          <CardContent className="p-8">
            <div className="text-center space-y-2 mb-8">
              ...
              <p className="text-text-secondary">Join DocLink today for better healthcare</p>
            </div>
            ...
            <div className="relative my-8 text-center">
              ...
              <span className="relative px-4 bg-transparent text-sm text-text-secondary">or join with</span>
            </div>
